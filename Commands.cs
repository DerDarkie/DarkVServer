...
namespace DarkVServer
{
    class Commands : IScript
    {
        ...
        {
            IVehicle veh = Alt.CreateVehicle(Alt.Hash(VehicleName), new AltV.Net.Data.Position(iplayer.Position.X, iplayer.Position.Y + 1.5f, iplayer.Position.Z), iplayer.Rotation);
            if(veh != null)
            {
